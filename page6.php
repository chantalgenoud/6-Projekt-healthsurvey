...
<div class = "col-12 m-5">
                <div class="integer">
                    <form name="myForm" action="page7.php" onsubmit="return validateNumber()" method="post"> <!-- muss noch erstellt werden -->
                        ...
                        <div>    
                            <input type="number" name="numberCarbon" id="numberCarbon">
                        </div>
                        <div class = "submit">
                        <br>
