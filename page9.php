...
<div class = "col-12 m-5">
                <div class="integer">
                    <form name="myForm" action="page10.php" onsubmit="return validateNumber()" method="post"> <!-- muss noch erstellt werden -->
                        <br>
                        <input type="hidden" name="pageID" value="page9"> <!--Hidden Field-->
                        <div>    
                            <input type="number" name="number9" id="number">
                        </div>
                        <div class = "submit">
                        <br>
