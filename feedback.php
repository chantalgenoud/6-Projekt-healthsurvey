...
<?php
if ($totalPoints >= 6) {  //der Schwellenwert sind 6 Punkte (von 10 möglichen) ?>
    <div class = "container">
        <div class = "row">
...
<br>Du lebst ungesund. Dein Ergebnis ist nicht als Urteil zu verstehen, sondern als eine Chance, die du nutzen solltest. Regelmässige Bewegung, sowie eine ausgelgelichene Ernährung sind Key für ein gesundes Leben. Tu es für dich! Weil du es dir Wert bist.</p>
        </div>
        <div class = "col-2 mt-4">
