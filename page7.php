...
<div class = "col-12 m-5">
                <div class="integer">
                    <form name="myForm" action="page8.php" onsubmit="return validateNumber()" method="post"> <!-- muss noch erstellt werden -->
                        <br>
